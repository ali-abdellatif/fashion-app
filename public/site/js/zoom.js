...
if ($(".thumbs-slider").length > 0) {
    ...
    function updateActiveColorButton(activeIndex) {
      ...
      if (currentColor) {
        var activeBtn = $(".color-btn[data-color='" + currentColor + "']").addClass("active");
        var displayName = activeBtn.data("value") || currentColor;
        $('.value-currentColor').text(displayName);
        $(".select-currentColor").text(displayName);
      }
    }
