        ...
        function renderMiniCart(data) {
            ...
            var itemsHtml = data.items.map(function (item) {
                ...
                return '<div class="tf-mini-cart-item" data-item-id="' + item.id + '">'
                    ...
                    + '</div>'
                    + '<div class="tf-mini-cart-remove mc-remove" data-item="' + item.id + '" style="cursor:pointer">{{ __("site.remove") }}</div>'
                    + '</div>'
                    + '</div>'
                    + '</div>';
            }).join('');
            ...
            el.innerHTML = '<div class="tf-mini-cart-wrap">'
                ...
                + '<div class="tf-cart-total">{{ __("site.cart-subtotal") }}</div>'
                + '<div class="tf-totals-total-value fw-6 mc-subtotal">' + data.subtotal + ' EGP</div>'
                + '</div>'
                + '<div class="tf-mini-cart-line mt-2 mb-2"></div>'
                + '<div class="tf-mini-cart-view-checkout">'
                + '<a href="' + cartPageUrl + '" class="tf-btn btn-outline radius-3 link w-100 justify-content-center">{{ __("site.view-cart") }}</a>'
                + '</div>'
                + '</div>'
                + '</div>'
                + '</div>';
