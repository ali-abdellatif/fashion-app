                ...
                <div class="row wrapper-header align-items-center">
                    ...
                    <div class="col-xl-3 col-md-4 col-6">
                        <a href="{{route('home')}}" class="logo-header">
                            <img src="{{ Storage::disk('public')->url($settings->logo) }}" alt="logo" class="logo">
                        </a>
                    </div>
                    <div class="col-xl-6 tf-md-hidden">
                        <nav class="box-navigation text-center">
                            <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                <li class="menu-item">
                                    <a href="{{ route('home') }}" class="item-link">{{__('site.home')}}</a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ route('shop') }}" class="item-link">{{__('site.shop')}}</a>
                                </li>
                                <!-- <li class="menu-item">
                                                    ...
                                                    <div class="mega-menu-item">
                                                        ...
                                                        <ul class="menu-list">
                                                            <li><a href="product-inner-zoom.html"
                                                                    class="menu-link-text link">Product inner zoom</a>
                                                            </li>
                                                            ...
                                                            <li><a href="product-zoom-popup.html"
                                                                    class="menu-link-text link">Product external zoom
                                                            ...
                                                            <li><a href="product-giftcard.html"
                                                                    class="menu-link-text link">Recipient information
                                                    ...
                                                    <div class="mega-menu-item">
                                                        ...
                                                        <ul class="menu-list">
                                                            ...
                                                            <li><a href="product-pre-orders.html"
                                                                    class="menu-link-text link">Product pre-orders</a>
                                                            </li>
                                                            ...
                                                            <li><a href="product-quick-order-list.html"
                                                                    ...
                                                                    order list<div class="demo-label"><span
                                                                            class="demo-new">New</span></div></a></li>
                                                            <li><a href="product-detail-volume-discount.html"
                                                                    class="menu-link-text link position-relative">Volume
                                                                    Discount<div class="demo-label"><span
                                                                            class="demo-new">New</span></div></a></li>
                                                            <li><a href="product-detail-volume-discount-grid.html"
                                                                    class="menu-link-text link position-relative">Volume
                                                                    Discount Grid<div class="demo-label"><span
                                                                            class="demo-new">New</span></div></a></li>
                                                            <li><a href="product-detail-buyx-gety.html"
                                                                    class="menu-link-text link position-relative">Buy X
                                                                    Get Y<div class="demo-label"><span
                                                                            class="demo-new">New</span></div></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="#" class="title link">Ribbed Tank
                                                                                Top</a>
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="#" class="title">Oversized Printed
                                                                                T-shirt</a>
                                                                            <span class="price">$16.95</span>
                                                                            <ul class="list-color-product">
                                                                                <li
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="#" class="title link">V-neck linen
                                                                                T-shirt</a>
                                                    ...
                                                    <ul class="menu-list">
                                                        <li>
                                                            <a href="brands.html"
                                                                ...
                                                                <div class="demo-label"><span
                                                                        class="demo-new">New</span></div>
                                                            </a>
                                                        </li>
                                                        <li><a href="brands-v2.html"
                                                                class="menu-link-text link text_black-2">Brand V2</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </li>
                                                ...
                                                <div class="sub-menu submenu-default">
                                                    <ul class="menu-list">
                                                        <li><a href="contact-1.html"
                                                                class="menu-link-text link text_black-2">Contact 1</a>
                                                        </li>
                                                        <li><a href="contact-2.html"
                                                                class="menu-link-text link text_black-2">Contact 2</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </li>
                                                ...
                                                <div class="sub-menu submenu-default">
                                                    <ul class="menu-list">
                                                        <li><a href="faq-1.html"
                                                                class="menu-link-text link text_black-2">FAQ 01</a></li>
                                                        <li><a href="faq-2.html"
                                                                class="menu-link-text link text_black-2">FAQ 02</a></li>
                                                    </ul>
                                                </div>
                                            </li>
                                            <li class="menu-item-2">
                                                ...
                                                <div class="sub-menu submenu-default">
                                                    <ul class="menu-list">
                                                        <li><a href="our-store.html"
                                                                class="menu-link-text link text_black-2">Our store</a>
                                                        </li>
                            ...
                            <li class="nav-wishlist">
                                @auth('customer')
                                    ...
                                    <a href="{{ route('wishlist.index') }}" class="nav-icon-item">
                                        ...
                                        <span class="count-box wishlist-count-badge" {{ $wishlistCount === 0 ? 'style=display:none' : '' }}>{{ $wishlistCount }}</span>
                                    </a>
                                @else
                                    <a href="#login" data-bs-toggle="modal" class="nav-icon-item">
                                        <i class="icon icon-heart"></i>
                                        <span class="count-box" style="display:none">0</span>
                                    </a>
                                @endauth
                            </li>
                            <li class="nav-cart">
                                @auth('customer')
                                    @php $cartCount = \App\Models\Cart::where('customer_id', auth('customer')->id())->first()?->items()->sum('quantity') ?? 0; @endphp
                                    <a href="#shoppingCart" data-bs-toggle="modal" class="nav-icon-item">
                                        <i class="icon icon-bag"></i>
                                        <span class="count-box cart-count-badge" style="{{ $cartCount === 0 ? 'display:none' : '' }}">{{ $cartCount }}</span>
                                    </a>
                                @else
                                    <a href="#login" data-bs-toggle="modal" class="nav-icon-item">
                                        <i class="icon icon-bag"></i><span class="count-box" style="display:none">0</span>
                                    </a>
                                @endauth
                            </li>
                        </ul>
