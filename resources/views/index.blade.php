...
<!-- Slider -->
                    ...
                    @forelse($sliders as $slider)
                        <div class="swiper-slide">
                            <div class="wrap-slider">
                                <img src="{{ Storage::disk('public')->url($slider->image) }}" alt="fashion-slideshow">
                    ...
                    @empty
                        <div class="swiper-slide">
                            <div class="wrap-slider">
                                <div class="box-content">
                                    <div class="container">
                                        <h1 class="fade-item fade-item-1">No Sliders Available</h1>
                                        <p class="fade-item fade-item-2">Please add sliders through the admin panel</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-4">
                        <div class="discovery-new-item">
                            <h5>{{ __('site.view-all-collection') }}</h5>
        ...
        <section class="flat-spacing-5 pt_0 flat-seller">
            <div class="container">
                <div class="flat-title">
                    <span class="title wow fadeInUp" data-wow-delay="0s">{{ __('site.best-sellers') }}</span>
                    <p class="sub-title wow fadeInUp" data-wow-delay="0s">{{ __('site.shop-latest-styles') }}</p>
                </div>
                <div class="grid-layout loadmore-item wow fadeInUp" data-wow-delay="0s" data-grid="grid-4">
                    ...
                    @empty
                        <p class="text-center">{{ __('No products available') }}</p>
                    @endforelse
                <!-- <div class="tf-pagination-wrap view-more-button text-center">
                    <button class="tf-btn-loading tf-loading-default style-2 btn-loadmore ">
                        <span class="text">{{__('site.load-more')}}</span></button>
                </div> -->
            </div>
        </section>
        <!-- /Seller -->
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="brand-item">
                                <img class="lazyload"
                                    data-src="{{ Storage::disk('public')->url($brand->logo) }}"
                                    src="{{ Storage::disk('public')->url($brand->logo) }}"
                                    alt="{{ $brand->name }}">
                            </div>
                        </div>
                        @endforeach
        ...
        <section class="flat-spacing-7">
            <div class="container">
                <div class="flat-title wow fadeInUp" data-wow-delay="0s">
                    <span class="title">{{ __('Shop Gram') }}</span>
                </div>
                                ...
                                <div class="gallery-item hover-img wow fadeInUp">
                                    <div class="img-style">
                                        <img class="lazyload img-hover"
                                            ...
                                            src="{{ $gallery->url }}"
                                            alt="image-gallery" style="width: 100%; height: 300px; object-fit: cover;">
                                    </div>
                                    @if($gallery->instagram_url)
                                    <a href="{{ $gallery->instagram_url }}" target="_blank" rel="noopener" class="box-icon">
                                        <span class="icon icon-instagram"></span>
                                        <span class="tooltip">{{ __('View on Instagram') }}</span>
                                    </a>
                                    @endif
                                </div>
                            </div>
